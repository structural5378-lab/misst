    ...
    <AdminSection title="Notifications" description="Send push notifications, emails, and emergency broadcasts">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl bg-card border border-border p-5">
          <h3 className="text-sm font-semibold text-foreground flex items-center gap-2 mb-4"><Radio className="w-4 h-4 text-violet-400" />Push Notification</h3>
          <div className="space-y-3">
            ...
            <Button onClick={sendPush} disabled={sending === "push" || !pushForm.title} className="w-full bg-violet-600 hover:bg-violet-700 text-white">
        ...
        {/* Email */}
        <div className="rounded-xl bg-card border border-border p-5">
          <h3 className="text-sm font-semibold text-foreground flex items-center gap-2 mb-4"><Mail className="w-4 h-4 text-cyan-400" />Email Notification</h3>
          <div className="space-y-3">
            ...
            <Button onClick={sendEmail} disabled={sending === "email" || !emailForm.to} className="w-full bg-cyan-600 hover:bg-cyan-700 text-white">
        ...
        {/* Emergency Broadcast */}
        <div className="rounded-xl bg-rose-500/5 border border-rose-500/20 p-5 lg:col-span-2">
          <h3 className="text-sm font-semibold text-rose-400 flex items-center gap-2 mb-4"><AlertTriangle className="w-4 h-4" />Emergency Broadcast</h3>
          ...
          <Button onClick={sendEmergency} disabled={sending === "emergency" || !emergencyForm.title} className="w-full mt-3 bg-rose-600 hover:bg-rose-700 text-white">
