-- MISST Core — Auth/User schema (Phase 1)
-- Run against the MISST PostgreSQL database before starting the Core backend.
-- Only the tables required for authentication/users are created here.
